...
import "./Kasuka-about.css";
import aboutImg from "../../Images/about.jpg";

export default function KasukaAbout() {
  return (
    <div className="kasuka-about-container">
      <div className="text-box">
        ...
        <span>
          <i class="fa-solid fa-check-double"></i>۱۰ سال تجربه ارایه خدمات تخصصی
          دیجیتال مارکتینگ و راهکارهای نوین بازاریابی
        </span>
        <span>
          <i class="fa-solid fa-check-double"></i>تمرکز ما در تمامی استراتژی های
          اجرایی معطوف به دیجیتال برندینگ و همسو کردن استراتژی های دیجیتال
          مارکتینگ با دیگر فعالیت های برندینگ و بازاریابی شما می باشد.
        </span>
        <span>
          <i class="fa-solid fa-check-double"></i>برای دریافت آخرین اخبار، گرایش
          ها و رویداد های دیجیتال مارکتینگ ثبت نام کنید
        </span>
        <p className="desc2">
